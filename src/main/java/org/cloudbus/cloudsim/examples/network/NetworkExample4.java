 ...
 *
 * <p>
 * The example defines a given latency for communication with the created
 * broker.
 * Since the broker receives multiple messages (such as for VM and Cloudlet
 * creation),
 ...
 * the total delay is the network latency multiplied by 3.
 * </p>
 */
public class NetworkExample4 {
  ...
  private void createAndSubmitCloudlets() {
    ...
    final var cloudlet1 = new CloudletSimple(length, VM_PES)
